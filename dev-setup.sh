...
print_header "🚀 Full-Stack Development Setup (Go-based PocketBase)"
...
# Install root dependencies first (this sets up Husky)
print_header "📦 Installing Root Dependencies"
npm install

# Setup Husky hooks (needs to be done after root npm install)
