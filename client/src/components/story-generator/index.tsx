...
export default function StoryGenerator() {
  ...
  const testRivetHealth = async () => {
    try {
      const response = await fetch('/api/rivet/health');
      const data = await response.json();
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <div className="text-xs text-gray-600 space-y-1">
          <p><code>POST /api/stories/generate</code> - Generate single story</p>
          <p><code>POST /api/stories/generate/batch</code> - Generate multiple stories</p>
          <p><code>GET /api/health</code> - System health check</p>
          <p><code>GET /api/rivet/health</code> - Rivet service health</p>
          <p><code>GET /api/test</code> - Test basic functionality</p>
        </div>
      </div>
    </div>
  );
